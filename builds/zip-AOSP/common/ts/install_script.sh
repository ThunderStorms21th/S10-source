...
cd /data/tmp/ts
$BB tar -Jxf kernel.tar.xz ThundeRStormS-Kernel-$BASE-AOSP-$MODEL_DESC-$VERSION.img
# $BB tar -xvf kernel.tar.xz ThundeRStormS-Kernel-$BASE-AOSP-$MODEL_DESC-$VERSION.img
dd of=/dev/block/platform/13d60000.ufs/by-name/boot if=/data/tmp/ts/ThundeRStormS-Kernel-$BASE-AOSP-$MODEL_DESC-$VERSION.img
