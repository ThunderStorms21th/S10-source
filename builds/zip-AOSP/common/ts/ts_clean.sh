...
#
# Usage:
#	ts_clean.sh [apk_package] -[options]
#
# Options:
...
#	    ts_clean.sh com.sec.android.app.music
#
#	clean in packages.xml and remove apk in data/app:
#	    ts_clean.sh com.sec.android.app.music -a
#
#	clean on packages.xml, remove in data/app, remove data, and remove in system
#	    ts_clean.sh com.sec.android.app.music -ads
#
#
# In a updater-script file, copy ts_clean.sh to tmp and:
#   run_program("/tmp/ts_clean.sh", "com.sec.android.app.music", "-ads");
#
#
