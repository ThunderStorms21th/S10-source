...
sed -i '/import \/init.services.rc/d' /system_root/system/etc/inithw//init.rc
...
# Copy kernel files
# cp /data/tmp/ts/system1/init.rc /system_root/system/etc/init/hw/
...
# cp /data/tmp/ts/system1/init.spectrum.sh /system_root/system/etc/init/hw/
# cp /data/tmp/ts/system1/spa /system_root/system/etc/init/hw/
# cp /data/tmp/ts/system1/init.spectrum.rc /system_root/system/etc/init/hw/
...
# chmod 755 /system_root/system/etc/init/hw/init.spectrum.rc
# chmod 755 /system_root/system/etc/init/hw/spa
# chmod 755 /system_root/system/etc/init/hw/init.spectrum.sh
...
sed -i '/import \/prism\/etc\/init\/init.rc/a\import \/system\/etc\/init\/hw\/init.custom.rc' /system_root/system/etc/init/hw/init.rc
