...
>>>>>>> d5398c96d8c5... ThunderStorms : upload readme.md and other files
...
It's possible to select a toolchain. By default, samsung's toolchain will be used
to build the kernel. For example, you can switch to proton toolchain by adding
"TOOLCHAIN: proton" line in the main.yml config file.
...
Available toolchains:
 ...
 - cruel - stable gcc 10.2.0 with LTO+PGO optimizations and reverted default inlining params to 9.3 version (https://github.com/CruelKernel/aarch64-cruel-elf)
